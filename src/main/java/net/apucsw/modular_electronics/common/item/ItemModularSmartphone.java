...
import net.apucsw.modular_electronics.common.CreativeTabModularElectronics;
...
public class ItemModularSmartphone extends ItemEnergized implements IModuleContainerItem, IModeItem, IGuiItem {
    ...
    public ItemModularSmartphone(Properties properties) {
        super(ModularElectronicsConfig.gear.modularSmartphoneBaseChargeRate, ModularElectronicsConfig.gear.modularSmartphoneBaseEnergyCapacity, properties.tab(ModularElectronics.tabModularElectronics).rarity(Rarity.COMMON).setNoRepair());
